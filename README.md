...
- **78 prompts.** A page of written instructions you copy and paste into an AI assistant
...
| **[`prompts/`](prompts/)** | 78 paste-ready analytical prompt templates across 14 categories — the broader library; each file pairs a prompt block with how-to and tuning sections |

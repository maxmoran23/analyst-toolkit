# Evidence — investigations-case-qa
...
The engine missed **0** of the **8,996** critical deficiencies planted in the test population. As with an attribute sample returning zero exceptions, that bounds the miss rate rather than proving it is nil: **below 0.03% at 95% confidence**, on this synthetic population.
...
| Wall-clock runtime | 1.13s |
| Interpreter | CPython 3.14.5 |
| Results digest | `0adfa7eb40d35f11` |

# Evidence — transaction-monitoring
...
The engine missed **0** of the **2,052** truly suspicious alerts planted in the test population. As with an attribute sample returning zero exceptions, that bounds the miss rate rather than proving it is nil: **below 0.15% at 95% confidence**, on this synthetic population.
...
| Wall-clock runtime | 0.65s |
| Interpreter | CPython 3.14.5 |
| Results digest | `72260f724af88900` |

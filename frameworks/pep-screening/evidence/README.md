...
The engine missed **0** of the **2,021** true PEP matches planted in the test population. As with an attribute sample returning zero exceptions, that bounds the miss rate rather than proving it is nil: **below 0.15% at 95% confidence**, on this synthetic population.
...
| Wall-clock runtime | 1.47s |
| Interpreter | CPython 3.14.5 |
| Results digest | `ed1e0a4129cfe2b2` |

...
| [`entity-resolution-confidence/`](entity-resolution-confidence/) | Resolve whether two identity records are the same person, different people, or indeterminate — transliteration/name-order aware, base-rate calibrated, identifier-weighted | **Built & validated** — dual gate: 0 true-same pairs cleared AND 0 name-only merges (auto-SAME structurally requires a shared strong identifier); six-seed stability, evidence committed |
| [`beneficial-ownership-resolution/`](beneficial-ownership-resolution/) | Resolve who ultimately owns or controls an entity — multi-path effective-ownership aggregation, circular-ownership convergence, control prongs, concealed-majority detection | **Built & validated** — dual gate: 0 true beneficial owners auto-cleared AND 0 auto-clears on unresolved/opaque chains; six-seed stability, evidence committed |
| [`sanctions-ownership-aggregation/`](sanctions-ownership-aggregation/) | The 50-percent-rule engine — is an entity blocked by ownership, owned ≥50% individually or in the aggregate, directly or indirectly, by sanctioned parties, even when no list names it | **Built & validated** — dual gate: 0 true blocked-by-ownership candidates auto-cleared (including multi-owner aggregation cases) AND 0 auto-clears on unresolved paths; six-seed stability, evidence committed |

...
The engine missed **0** of the **2,750** planted critical defects planted in the test population. As with an attribute sample returning zero exceptions, that bounds the miss rate rather than proving it is nil: **below 0.11% at 95% confidence**, on this synthetic population.
...
| Wall-clock runtime | 2.86s |
| Interpreter | CPython 3.14.5 |
| Results digest | `6f6c9df784f391d9` |

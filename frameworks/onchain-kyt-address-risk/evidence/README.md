# Evidence — onchain-kyt-address-risk
...
The engine missed **0** of the **3,055** truly tainted addresses planted in the test population. As with an attribute sample returning zero exceptions, that bounds the miss rate rather than proving it is nil: **below 0.10% at 95% confidence**, on this synthetic population.
...
| Wall-clock runtime | 0.53s |
| Interpreter | CPython 3.14.5 |
| Results digest | `36430cd5379711c3` |

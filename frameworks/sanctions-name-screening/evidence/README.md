# Evidence — sanctions-name-screening
...
The engine missed **0** of the **997** true matches planted in the test population. As with an attribute sample returning zero exceptions, that bounds the miss rate rather than proving it is nil: **below 0.30% at 95% confidence**, on this synthetic population.
...
| Wall-clock runtime | 2.49s |
| Interpreter | CPython 3.14.5 |
| Results digest | `94abc04ba1d4c354` |

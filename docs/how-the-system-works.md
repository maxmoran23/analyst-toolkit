...
the quality bar. There are 87 of them across 15 categories. You fill in a few
...
alerts a month, where almost all are false positives. There are 17 of them. Each
...
| **Model Risk & Governance** | Model-governance review and SR 11-7 validation-workpaper prompts, plus all 17 frameworks' validation evidence as worked examples | The frameworks *are* worked examples of validated models |
